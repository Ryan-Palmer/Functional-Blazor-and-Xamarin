...
The Razor component subscribes to the model updates in OnAfterRenderAsync and disposes the subscription token in its Dispose method which is automatically called when the user navigates away from the page.
